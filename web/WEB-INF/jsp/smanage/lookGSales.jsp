            ...
            <ul class="nav nav-pills nav-stacked dept_sidebar">
                <li role="presentation" class="active">
                    ...
                    <ul class="nav nav-pills nav-stacked" id="collapse_sales">
                        <li role="presentation"><a href="#">商品销售总额</a></li>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
                    <ol class="breadcrumb">
                        ...
                        <%
                            List<Goods> goods=(List) session.getAttribute("goods");
                        ...
                        %>
                        <form action="/sales/searchGSales" onsubmit="return submit_from()">
                            <div>
                                开始：<input type="date" name="start" required="required">
                                结束：<input type="date" name="end" required="required">
                                <select name="gname" style="border: none;width: 144px;height: 26px;">
                ...
                <h2 style="text-align: center;">所有商品销售总额为<%=all%></h2>
