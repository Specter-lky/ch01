...
<div class="hrms_container">
    ...
    <div class="hrms_body" style="position:relative; top:-15px;">
        ...
        <div class="emp_info col-sm-10">
            ...
            <form action="/client/updateClient" method="post" style="text-align: center;">
                <table border="2" cellspacing="0" cellpadding="0" bgcolor="#95BDFF" width="60%" align="center">
                    <%
                        Client client=(Client) session.getAttribute("client");
                    %>
                    <tr>
                        <td height="30">客户编号</td>
                        <td><input type="text" name="no" value="<%=client.getC_no()%>" readonly = "readonly" style="border:none;"></td>
                    </tr>
                    <tr>
                        <td height="30">客户姓名：</td>
                        <td><input type="text" required="required" name="name" value="<%=client.getC_name()%>"></td>
                    </tr>
                    <tr class="msg">
                        <td height="30">客户电话：</td>
                        <td><input type="text" required="required" value="<%=client.getC_phone()%>" onkeyup="this.value=this.value.replace(/\D/g, '')" name="phone"></td>
                    </tr>
                    <tr class="msg">
                        <td height="30">客户地址：</td>
                        <td><input type="text" required="required" name="adress" value="<%=client.getC_adress()%>"></td>
                    </tr>
                    <tr class="msg">
