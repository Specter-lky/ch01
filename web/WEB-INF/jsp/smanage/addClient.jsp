...
<div class="hrms_container">
    ...
    <div class="hrms_body" style="position:relative; top:-15px;">
        ...
        <div class="emp_info col-sm-10">
            ...
            <form action="/client/addClient" method="post" style="text-align: center;">
                <div>
                    客户姓名：<input type="text" required="required" name="name">
                </div>
                <div class="msg">
                    客户电话：<input type="text" required="required" onkeyup="this.value=this.value.replace(/\D/g, '')" name="phone">
                </div>
                <div class="msg">
                    客户住址：<input type="text" required="required" name="adress">
                </div>
                <div class="msg">
