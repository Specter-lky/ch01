        ...
        <div class="emp_info col-sm-10">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
                    <ol class="breadcrumb">
                        <li><a href="/dlist/clookDList">发货单管理</a></li>
                ...
                <table class="table table-bordered table-hover" id="emp_table">
                    ...
                    <tbody>
                    <%
                        DList l=(DList)session.getAttribute("one");
                        if (l==null){
                            String msg = "无该发货单！";
                            ...
                            double total=l.getDl_num()*l.getG_price();
                            int status=l.getDl_status();
                            String str="";
                            if(status==0){
                                str="未发货";
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <%
                                if(status==0){
                            %>
                            <a href="/dlist/delivergoods?dlno=<%=l.getDl_no()%>" role="button" class="btn btn-primary">发货</a>
                            <%
                                }
                            %>
                        </td>
