            ...
            <ul class="nav nav-pills nav-stacked dept_sidebar">
                <li role="presentation" class="active">
                    ...
                    <ul class="nav nav-pills nav-stacked" id="collapse_sales">
                        <li role="presentation"><a href="/sales/lookownContract?sno=<%=sno%>">查看签订合同</a></li>
                        <li role="presentation"><a href="/sales/lookSperformance?sno=<%=sno%>">查看销售业绩</a></li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="emp_info col-sm-10">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
                    <ol class="breadcrumb">
                        <li><a href="/sales/lookSperformance">销售额查看</a></li>
                ...
                <table class="table table-bordered table-hover" id="emp_table">
                    ...
                    <tbody>
                    <%
                        List<Contract> list=(List)session.getAttribute("contract");
                ...
                <h2 style="text-align: center;">此时间段内销售业绩为${total}</h2>
